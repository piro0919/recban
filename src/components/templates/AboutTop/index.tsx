      ...
      <div className={styles.inner}>
        ...
        >
          <div className={styles.inner2}>
            ...
            <p>
              返信につきましては基本的に行っておりませんので、あらかじめご了承ください。
              <br />
              また、基本的にりくばん！に対する機能のご要望は受け付けておりません。
              <br />
              機能のご要望を行いたい場合につきましては、寄付の項目をお読みください。
            </p>
          </div>
        </Article>
        <Article
        ...
        >
          <div className={styles.inner2}>
            ...
            <p>
              またりくばん！に対するご要望がございましたら、寄付の際に合わせてご連絡いただけますと幸いです。
              <br />
              ただし、すべてのご要望にお答えすることはできませんので、あらかじめご了承ください。
              <br />
              また一定の金額以上ご寄付していただいた方につきましては、感謝の意を込めて以下にお名前を掲載させていただきます。
              <br />
